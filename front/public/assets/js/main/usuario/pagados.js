export async function inicializar_pagados() {
    iniciar_data_table();
}

//si no hay pagados, la pestaña no aparecerá
...
export async function iniciar_data_table() {
    ...
    tabla = new DataTable("#tbl-pagados", {
        ajax: {
            url: get_expedientes_pagados_usuarios,
            type: "GET",
        ...
        buttons: [
            {
                ...
                title: "Expedientes pagados",
                filename: "expedientes_pagados"
            }
        ]
    });
...
function mostrar_ocultar_pestania(hay_datos) {
    const pestania = document.getElementById("pestania-pagados");
    if(hay_datos){
